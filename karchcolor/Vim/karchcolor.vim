if &background == 'dark'
  ...
  let s:guiaccent0 = "#C80000"
  let s:guiaccent1 = "#D66000"
  let s:guiaccent2 = "#FAC800"
  let s:guiaccent3 = "#14B414"
  let s:guiaccent4 = "#15A2D1"
  let s:guiaccent5 = "#1A4CE0"
  let s:guiaccent6 = "#F5F5F5"
  let s:guiaccent7 = "#DA0777"
  ...
  let s:ctermshade7 = 255
  let s:ctermaccent0 = 160
  let s:ctermaccent1 = 172
  let s:ctermaccent2 = 220
  let s:ctermaccent3 = 40
  let s:ctermaccent4 = 38
  let s:ctermaccent5 = 62
  let s:ctermaccent6 = 255
  let s:ctermaccent7 = 162
endif

highlight clear
syntax reset
let g:colors_name = "karchcolor"
